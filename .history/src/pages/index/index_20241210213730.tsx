...
import Taro, { useLoad, chooseImage, getMenuButtonBoundingClientRect, getSystemInfoSync } from '@tarojs/taro'
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    setNavBarInfo({
      ...
      menuButtonTop: menuButton.top - systemInfo.statusBarHeight
    })
  }, [])
    ...
    <View className='index'>
      ...
      >
        <View
          ...
          style={{
            height: navBarInfo.menuButtonHeight + 'px',
            lineHeight: navBarInfo.menuButtonHeight + 'px',
            top: navBarInfo.menuButtonTop + 'px'
          }}
        >
      ...
      <View
        ...
        style={{
          marginTop: (navBarInfo.statusBarHeight + navBarInfo.navBarHeight) + 'px'
        }}
      >
        {/* 提示文本 */}
