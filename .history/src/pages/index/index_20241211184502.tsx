        ...
        <View className='stats-card'>
          ...
          <View className='stats-grid'>
            <View className='stat-item'>
              <Text className='value protein'>{dailyNutrients.protein.toFixed(1)}g</Text>
              <Text className='label'>蛋白质</Text>
            </View>
            <View className='stat-item'>
              <Text className='value fat'>{dailyNutrients.fat.toFixed(1)}g</Text>
              <Text className='label'>脂肪</Text>
            </View>
            <View className='stat-item'>
              <Text className='value carbs'>{dailyNutrients.carbs.toFixed(1)}g</Text>
        ...
        <View className='daily-goals'>
          <View className='goal-item'>
            <View className='goal-header'>
              ...
              <Text className='value'>{dailyNutrients.calories.toFixed(0)}/2500</Text>
            </View>
            <View className='progress-bar'>
              <View
                className='progress calories'
                style={{ width: `${Math.min((dailyNutrients.calories / 2500) * 100, 100)}%` }}
              />
            </View>
          </View>
        </View>
